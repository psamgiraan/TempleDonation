...
def broadcast_sms1(user_donation,):
    mobile_number = user_donation.donor_details
    first_name = user_donation.applicant_name
    donation_amount = user_donation.donation_amount

    message_to_broadcast = (f"Hello Tomorrow is Your donation date Please Pay donation")
...
def broadcast_sms(obj):
    mobile_number = obj.donor_details
    first_name = obj.applicant_name
    donation_amount = obj.current_received_amount
    donation_status=obj.donation_status
